<template>
  <div class="publish-wrapper">
    <div class="publish-card">
      ...
      <form @submit.prevent="handleEdit" class="form-panel">
        ...
        <div class="input-group">
          ...
          <div class="upload-area" @click="triggerFileInput">
            ...
            <div class="upload-placeholder">
              ...
              <span>{{ imageFile ? imageFile.name : (form.images ? '已有图片，可重新上传' : '点击上传图片') }}</span>
            </div>
          </div>
          ...
          <div v-else-if="form.images && !imageFile" class="image-preview">
            <img :src="getFirstImage()" alt="商品图片" />
          </div>
        </div>
...
const handleEdit = async () => {
  ...
  try {
    let imageUrls = form.images ? JSON.parse(form.images) : []
    if (imageFile.value) {
    ...
    const res = await axios.put(`${BASE_URL}/product/edit/${productId}`, productData, {
      withCredentials: true,
